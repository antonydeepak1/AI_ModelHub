...
const models = [
  {
    title: "Medical Text Simplifier",
    description: "Simplifies and translates complex medical texts for clarity.",
  ...
  },
  {
    ...
    description: "Generate full code snippets using your ideas and preferred frameworks.",
    icon: <Bot className="w-6 h-6 text-primary" />,
    image: "/images/codegen.jpg",
    route: "/codegen",
    tag: "GenAI"
  }
];
